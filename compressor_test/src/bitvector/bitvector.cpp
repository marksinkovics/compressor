...
TEST_F(BitVectorTests, CopyOperators) {
    BitVector v1(8);
    v1.set(0);
    v1.set(7);
...
TEST_F(BitVectorTests, MoveOperators) {
    BitVector v1(9);
    v1.set(0);
...
TEST_F(BitVectorTests, Relational)
{
    BitVector v1{"0101"};
    BitVector v2{"0101"};
    BitVector v3{"1101"};
...
TEST_F(BitVectorTests, push_back)
{
    BitVector v1(0);        //
    v1.push_back(true);     //1
    ASSERT_TRUE(v1[0]);
...
TEST_F(BitVectorTests, Append)
{
    BitVector v1("011");
    BitVector v2("00");    //00
    v2.append(v1);      //01100
    EXPECT_EQ(BitVector("01100"), v2);
    v2.append(v1);
    EXPECT_EQ(BitVector("01101100"), v2);
}

TEST_F(BitVectorTests, File)
{
    std::stringstream stream;
    BitVector in0;
    BitVector in1("0");
    BitVector in2("101101101");
    BitVector in3("101101101101101101");
